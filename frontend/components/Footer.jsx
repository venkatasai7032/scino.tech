...
const footerLinks = {
  ...
  // Resources section removed - pages don't exist yet
  // TODO: Add back Documentation, API, Blog, Community, Changelog when pages are created
  company: {
    title: 'Company',
    links: [
      { label: 'About', href: '/#founder' },
      // Careers page removed - doesn't exist yet
      // TODO: Add back Careers link when page is created
