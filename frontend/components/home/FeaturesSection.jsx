              ...
              <Card variant="glass" padding="lg" className={`h-full border ${feature.borderColor} group/feature overflow-visible`} hover>
                ...
                <div className={`relative z-10 ${feature.size === 'large' ? 'flex flex-col sm:flex-row gap-6 items-start' : ''}`}>
                  ...
                  <div className="flex-1">
                    ...
                    <motion.a href={feature.href || '/#founder'} className="inline-flex items-center gap-1.5 mt-4 text-sm font-semibold text-scino-600 dark:text-scino-400 hover:text-scino-700 dark:hover:text-scino-300 transition-colors duration-200" whileHover={{ x: 4 }}>
