...
import { SkillsPieChart } from '@/components/ui/ProgressChart';
import { User, BarChart3, BookOpen, Award, Trophy, Target, Flame, Zap, Lock } from 'lucide-react';
                  ...
                  <GlassCard className="p-6">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                      <div className="text-center">
                        <Achievement3D type="trophy" />
                        <p className="text-sm font-medium text-dark-900 dark:text-white mt-2">First Level</p>
                      </div>
                      <div className="text-center">
                        <Achievement3D type="trophy" />
                        <p className="text-sm font-medium text-dark-900 dark:text-white mt-2">7-Day Streak</p>
                      </div>
                      <div className="text-center">
                        <Achievement3D type="trophy" />
                        <p className="text-sm font-medium text-dark-900 dark:text-white mt-2">Quick Learner</p>
                      </div>
                      <div className="text-center">
                        <div className="w-24 h-24 mx-auto flex items-center justify-center rounded-full bg-dark-100 dark:bg-dark-800">
                          <Lock size={32} className="text-dark-400 dark:text-dark-500" />
                        </div>
                        <p className="text-sm font-medium text-dark-500 dark:text-dark-400 mt-2">Locked</p>
                      </div>
                    </div>
                  </GlassCard>
