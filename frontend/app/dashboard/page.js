...
import { XPProgressChart, ActivityBarChart, StreakLineChart } from '@/components/ui/ProgressChart';
import AnimatedProgressRing from '@/components/ui/AnimatedProgressRing';
import XP3DOrb from '@/components/3d/XP3DOrb';
          ...
          <motion.div variants={containerVariants} initial="hidden" animate="visible">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
              ...
              <div className="lg:col-span-8 space-y-6">
                ...
                {/* XP Card — Real Data with 3D */}
                <motion.div variants={itemVariants}>
                  <GlassCard className="p-6">
                    <div className="flex flex-col lg:flex-row items-center gap-6">
                      <XP3DOrb color="#06b6d4" size={2.5} />
                      <div className="flex-1 w-full">
                        <div className="flex items-center justify-between mb-4">
                          <div>
                            <h3 className="text-lg font-bold text-dark-900 dark:text-white">XP Progress</h3>
                            <p className="text-sm text-dark-500 dark:text-dark-400">Level {userData.currentLevel} • {userData.rank}</p>
                          </div>
                          <AnimatedProgressRing progress={userData.xpInLevel} size={80} strokeWidth={6} color="#06b6d4" />
                        </div>
                        <XPProgressChart />
                      </div>
                    </div>
