...
import { 
  Database, Brain, BarChart3, LineChart, PieChart,
  Unlock, PlayCircle, CheckCircle2,
  Star, Clock, BookOpen, ArrowRight, TrendingUp
} from 'lucide-react';
...
const levels = [
  {
    ...
    description: 'Learn the fundamentals of data science, statistics, and the data lifecycle',
    difficulty: 'basic',
    duration: '50 min',
    xp: 70,
    completed: true,
  ...
  },
  {
    ...
    description: 'Master Python programming with NumPy, Pandas, and data manipulation',
    difficulty: 'basic',
    duration: '75 min',
    xp: 100,
    completed: false,
  ...
  },
  {
    ...
    description: 'Deep dive into statistics, hypothesis testing, and probability distributions',
    difficulty: 'intermediate',
    duration: '80 min',
    xp: 130,
    completed: false,
  ...
  },
  {
    id: 6,
    title: 'Deep Learning',
    description: 'Neural networks, CNNs, RNNs, and TensorFlow/PyTorch fundamentals',
    difficulty: 'advanced',
    duration: '120 min',
    xp: 200,
    completed: false,
  ...
  },
  {
    ...
    description: 'Work with large datasets using Spark, Hadoop, and distributed computing',
    difficulty: 'advanced',
    duration: '100 min',
    xp: 180,
    completed: false,
  ...
  },
  {
    ...
    description: 'Build data pipelines, ETL processes, and data warehouse architecture',
    difficulty: 'advanced',
    duration: '110 min',
    xp: 190,
    completed: false,
          ...
          <div className="relative z-10 max-w-6xl mx-auto">
            ...
            >
              ...
              <p className="text-xl text-white/80 max-w-2xl mb-8">
                Master data science from Python fundamentals to deep learning. 
                Learn machine learning, big data analytics, and become a data scientist.
              </p>
                ...
                >
                  ...
                  >
                    ...
                    <div className="p-5">
                      ...
                      {!level.locked && (
                        <Link
                          href={`/learn/datascience/${level.id}`}
