...
import { 
  Code2, Terminal, Database, Globe, Smartphone, 
  Lock, Unlock, PlayCircle, CheckCircle2,
  Star, Clock, BookOpen, ArrowRight, Cpu
} from 'lucide-react';
...
const levels = [
  {
    id: 1,
    title: 'Hello World',
    description: 'Write your first program and understand the basics of programming',
    difficulty: 'basic',
    duration: '20 min',
    xp: 40,
    completed: true,
  ...
  },
  {
    ...
    description: 'Work with arrays, lists, dictionaries, and more',
    difficulty: 'intermediate',
    duration: '60 min',
    xp: 120,
    completed: false,
  ...
  },
  {
    ...
    description: 'Connect your applications to external services and APIs',
    difficulty: 'advanced',
    duration: '90 min',
    xp: 180,
    completed: false,
  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-dark-50/50 dark:bg-dark-950">
        {/* Hero Section */}
        <div className="relative bg-gradient-to-br from-neon-purple via-purple-600 to-indigo-700 pt-20 pb-16 px-4 overflow-hidden">
          ...
          <div className="relative z-10 max-w-6xl mx-auto">
            ...
            >
              ...
              <p className="text-xl text-white/80 max-w-2xl mb-8">
                ...
                From Hello World to building real-world applications.
              </p>
