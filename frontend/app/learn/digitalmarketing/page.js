...
import { 
  TrendingUp, Megaphone, Smartphone, Globe, Mail,
  Unlock, PlayCircle, CheckCircle2,
  Star, Clock, BookOpen, ArrowRight, Target
} from 'lucide-react';
...
const levels = [
  {
    ...
    description: 'Learn the basics of digital marketing, customer journey, and marketing funnels',
    difficulty: 'basic',
    duration: '40 min',
    xp: 50,
    completed: true,
  ...
  },
  {
    ...
    description: 'Learn search engine optimization, keyword research, and content strategy',
  ...
  },
  {
    ...
    description: 'Master Google Ads, Facebook Ads, and pay-per-click advertising',
    difficulty: 'intermediate',
    duration: '65 min',
    xp: 100,
    completed: false,
  ...
  },
  {
    ...
    description: 'Build email lists, create campaigns, and master email automation',
    difficulty: 'intermediate',
    duration: '50 min',
    xp: 80,
    completed: false,
  ...
  },
  {
    ...
    description: 'Use Google Analytics, track metrics, and make data-driven decisions',
    difficulty: 'advanced',
    duration: '75 min',
    xp: 130,
    completed: false,
  ...
  },
  {
    ...
    description: 'Partner with influencers, build brand partnerships, and measure ROI',
    difficulty: 'advanced',
    duration: '60 min',
    xp: 100,
    completed: false,
  ...
  },
  {
    ...
    description: 'Set up automated marketing workflows, CRM integration, and lead nurturing',
    difficulty: 'advanced',
    duration: '85 min',
    xp: 150,
    completed: false,
  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-dark-50/50 dark:bg-dark-950">
        {/* Hero Section */}
        <div className="relative bg-gradient-to-br from-pink-500 via-rose-600 to-red-700 pt-20 pb-16 px-4 overflow-hidden">
          ...
          <div className="relative z-10 max-w-6xl mx-auto">
            ...
            >
              ...
              <p className="text-xl text-white/80 max-w-2xl mb-8">
                Master digital marketing from social media to SEO. 
                Learn Google Ads, content marketing, and become a marketing expert.
              </p>
                ...
                >
                  ...
                  >
                    ...
                    <div className="p-5">
                      ...
                      {!level.locked && (
                        <Link
                          href={`/learn/digitalmarketing/${level.id}`}
