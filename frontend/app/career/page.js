                ...
                <motion.div key={career.id}
                  ...
                  <div className="p-6 space-y-5">
                    ...
                    <div className="flex items-center justify-between pt-4 border-t border-dark-100 dark:border-dark-800">
                      ...
                      <Link href={
                        career.id === 'scientist' ? '/programs/scientist' :
                        career.id === 'software' ? '/programs/coding' :
                        career.id === 'ai-engineer' ? '/programs/ai-ml' :
                        career.id === 'cybersecurity' ? '/programs/coding' : // TODO: Point to real cybersecurity course page once it exists
                        '/programs/coding'
                      }
